  ...
  counts(NULL), displacements(NULL)
{
  ...
  // TODO: let's define k in eV for consistency with other input parameters
...
//        TODO: added equality so that the last else statement is not needed
...
// TODO: i think this is redundant becuase tangent has been projected before
//  if this projection affects on results then there is some bug above and also
//  tlen in this case needs to be recalculated
